...
import { alpha, Box, Button, Chip, FormControl, FormHelperText, Grid, IconButton, MenuItem, Paper, Select, Switch, TextField, Tooltip, Typography, useTheme } from '@mui/material';
import {
        ...
        <Grid width="100%">
          ...
          <Chip
            ...
            sx={{
              ...
              height: 'auto',
              width: "100%",
              background: `linear-gradient(135deg, rgba(195, 225, 255, 0.5), rgba(0, 115, 205, 0.5))`,
              color: 'text.secondary',
